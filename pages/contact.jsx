        ...
        <BannerLayout>
            <div className=" px-4 py-2">
                    ...
                    <div className="flex flex-col md:flex-row items-center gap-5 text-xs">
                        <div className="card_stylings w-full md:w-1/2 p-5 md:p-6 lg:p-8 flex flex-col gap-y-4">
                            ...
                            <div className="flex justify-between items-center">
                                ...
                                <span className='text-LightGray md:text-sm'>Batticaloa</span>
                            </div>
                            {/* /* <div className="flex justify-between items-center">
                        ...
                        <div className="card_stylings rounded-xl w-full md:w-1/2 p-5 md:p-6 lg:p-8 flex flex-col gap-y-4">
                            <div className="flex justify-between items-center">
                                ...
                                <span className='text-LightGray text-sm'>musaithaani@gmail.com</span>
                            </div>
                            <div className="flex justify-between items-center">
                                <span className='md:text-base'>LinkedIn:</span>
                                <a 
                                    href="www.linkedin.com/in/musaitha-basheer" 
                                    className='text-LightGray text-sm' 
                                    target="_blank" 
                                    rel="noopener noreferrer">Musaitha Basheer
                                </a>
                            </div>
                ...
                <div className="h-16 w-full card_stylings text-xl sm:text-3xl flex gap-x-8 sm:gap-x-16 items-center justify-center text-Snow">
                    ...
                    <a className='hover:scale-125 ease-in-out duration-700' href="https://github.com/MhaaniBA" target='_blank' rel="noreferrer"><FaGithub /></a>
                    <a className='hover:scale-125 ease-in-out duration-700' href="www.linkedin.com/in/musaitha-basheer" target='_blank' rel="noreferrer"><FaLinkedin /></a>
